...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    publinkUSERAuthUserSubject.add(
      PublinkUSERAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<PublinkUSERAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  PublinkUSERAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = PublinkUSERAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    publinkUSERAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
PublinkUSERAuthUser? currentUser;
