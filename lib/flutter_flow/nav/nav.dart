...
class AppStateNotifier extends ChangeNotifier {
  ...
  PublinkUSERAuthUser? initialUser;
  PublinkUSERAuthUser? user;
  ...
  void update(PublinkUSERAuthUser newUser) {
    final shouldUpdate =
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'HomePage_user')
        ...
        FFRoute(
          ...
          path: '/eventsUser',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Events_user')
        ...
        FFRoute(
          ...
          path: '/barsUser',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Bars_user')
              : const BarsUserWidget(),
        ),
        FFRoute(
          name: 'Profile_user',
          path: '/profileUser',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Profile_user')
