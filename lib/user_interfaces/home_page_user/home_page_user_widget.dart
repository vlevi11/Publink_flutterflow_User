                  ...
                  child: SizedBox(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        final pageViewNewsAPIResponse = snapshot.data!;

                        return Builder(
                          builder: (context) {
                            final newsDB = NewsAPICall.image(
                                  pageViewNewsAPIResponse.jsonBody,
                                )?.toList() ??
                                [];
                                ...
                                children: [
                                  PageView.builder(
                                    controller: _model.pageViewController ??=
                                        PageController(
                                            initialPage: max(
                                                0, min(0, newsDB.length - 1))),
                                    scrollDirection: Axis.horizontal,
                                    itemCount: newsDB.length,
                                    itemBuilder: (context, newsDBIndex) {
                                      final newsDBItem = newsDB[newsDBIndex];
                                      return Column(
                                        mainAxisSize: MainAxisSize.max,
                                        children: [
                                          Padding(
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  ...
                                                  image: DecorationImage(
                                                    fit: BoxFit.cover,
                                                    image: Image.network(
                                                      'https://publink.alsohaz.hu/uploads/$newsDBItem',
                                                    ).image,
                                                  ),
                                                  boxShadow: const [
                                                    BoxShadow(
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Builder(
                                builder: (context) {
                                  final barok = listViewBarokAPIResponse
                                      .jsonBody
                                      .toList();
                                              ...
                                              children: [
                                                Hero(
                                                  tag: valueOrDefault<String>(
                                                    'https://publink.alsohaz.hu/uploads/${getJsonField(
                                                      barokItem,
                                                      r'''$.headerImage''',
                                                    ).toString()}',
                                                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/ismerkedes1-pys4wl/assets/marbyp3gdp81/faszsag.gif' '$barokIndex',
                                                  ),
                                                  ...
                                                  child: ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        ...
                                                        'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/ismerkedes1-pys4wl/assets/marbyp3gdp81/faszsag.gif',
                                                      ),
                                                      width: double.infinity,
                                                      height: 120.0,
                                                      fit: BoxFit.cover,
                        ...
                        child: Padding(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              final listViewEsemenyekAPIResponse =
                                  snapshot.data!;

                              return Builder(
                                builder: (context) {
                                  final events = listViewEsemenyekAPIResponse
                                      .jsonBody
                                      .toList();
