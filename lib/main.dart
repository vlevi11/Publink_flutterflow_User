...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<PublinkUSERAuthUser> userStream;
  ...
  void initState() {
    ...
    userStream = publinkUSERAuthUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'HomePage_user';
  ...
  Widget build(BuildContext context) {
    final tabs = {
      'HomePage_user': const HomePageUserWidget(),
      'Events_user': const EventsUserWidget(),
      'Bars_user': const BarsUserWidget(),
      'Profile_user': const ProfileUserWidget(),
    };
